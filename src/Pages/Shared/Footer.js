        ...
        <div>
            <footer class="footer footer-center p-10 bg-primary text-primary-content">
                <div>
                    ...
                    <p class="font-bold">
                        Cakeries Bangladesh Ltd. <br />Providing reliable baking tools since 2002
                    </p>
                    <p className='font-semibold'>Copyright © 2022 - All right reserved by Cakeries Bangladesh Ltd.</p>
                </div>
                <div>
