        ...
        <div className="hero min-h-screen ">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <p className="py-6 text-lg">To ensure a proper baking we provide every tool you need. In order to bake perfectly you must choose tools which are truly baking friendly. We Store items from worldwide only to provide you the best.</p>
                <Link to={'/contact'}>
